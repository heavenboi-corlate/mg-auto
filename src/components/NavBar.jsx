      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <span className="text-2xl font-bold text-white">AutoCare<span className="text-yellow-400">Pro</span></span>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors">About</a>
              <a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors">Services</a>
              <a href="#" className="text-gray-300 hover:text-yellow-400 transition-colors">Testimonials</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-slate-800 transition-all duration-300 ease-in-out">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#" className="block px-3 py-2 text-gray-300 hover:bg-gray-700 rounded-md">Testimonials</a>
